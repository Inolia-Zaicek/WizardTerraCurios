...
public class SharpeningStationItem extends BuffItem {

    public SharpeningStationItem() {
        super(ModRarity.GRAY);
    }
    @Override
    public MobEffectInstance getPotionEffect() {
        return new MobEffectInstance(WTCEEffectsRegister.Sharpened.get(), 10 * 60 * 20, 0);
    }
}