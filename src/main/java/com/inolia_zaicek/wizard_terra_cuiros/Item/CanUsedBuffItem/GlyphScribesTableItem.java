...
public class GlyphScribesTableItem extends BuffItem {

    public GlyphScribesTableItem() {
        super(ModRarity.PURPLE);
    }
    @Override
    public MobEffectInstance getPotionEffect() {
        return new MobEffectInstance(WTCEEffectsRegister.ArsSource.get(), 10 * 60 * 20, 0);
    }
}