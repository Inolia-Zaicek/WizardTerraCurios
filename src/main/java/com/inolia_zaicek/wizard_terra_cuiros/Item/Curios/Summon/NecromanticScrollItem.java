...
public class NecromanticScrollItem extends Item implements ICurioItem {
    public NecromanticScrollItem() {
    ...
    public Multimap<Attribute, AttributeModifier> getAttributeModifiers(SlotContext slotContext, UUID uuid, ItemStack stack) {
        ...
        attributes.put(WTCAttributes.Summon_Damage.get(), new AttributeModifier(uuid, getTooltipItemName(), WTCConfig.NecromanticScroll.get(), AttributeModifier.Operation.MULTIPLY_TOTAL));
        return attributes;
    }
    @Override
    public boolean canEquip(SlotContext slotContext, ItemStack stack) {
        return WTCUtil.noSameCurio(slotContext.entity(), WTCItemRegister.NecromanticScroll.get());
    }
}